...
flags.DEFINE_float("depth_weight",                 1.0,    "Weight for depth supervision")
...
flags.DEFINE_string("depth_test_split",        "eigen",    "KITTI depth split, eigen, stereo or mine")
#flags.DEFINE_integer("pose_test_seq",                9,    "KITTI Odometry Sequence ID to test")
flags.DEFINE_string("pose_test_seq",              None,     "Sequence folders to test pose")
flags.DEFINE_string("depth_test_seq",             None,     "Sequence folders to test depth")

##### Additional Configurations #####
flags.DEFINE_integer("num_source",                None,    "Number of source images")
flags.DEFINE_integer("num_scales",                None,    "Number of scales")
flags.DEFINE_boolean("add_flownet",               None,    "Add flownet")
flags.DEFINE_boolean("add_dispnet",               None,    "Add dispnet")
flags.DEFINE_boolean("add_posenet",               None,    "Add posenet")
flags.DEFINE_string("dataset_name",               None,    "kitti_raw, kitti_odom, rms_hallway, MobileRGBD, other")
...
def train():
    ...
    with tf.Graph().as_default():
        ...
        tgt_image, src_image_stack, depth_seq, intrinsics = loader.load_train_batch()

        # Build Model
        model = GeoNetModel(opt, tgt_image, src_image_stack, depth_seq, intrinsics)
